...
class AboutImplicits extends KoanSuite with ShouldMatchers {
  ...
  koan("""Implicits can be used to automatically convert one type to another""") {
    ...
    //This looks pretty dangerous/powerful, to illustrate this point, I've modified the koan
    implicit def Int2BigIntegerConvert(value: Int): BigInteger = new BigInteger("10")

    def add(a: BigInteger, b: BigInteger) = a.add(b)

    add(3, 6) should be(new BigInteger("20"))
  }
  ...
  koan("""Implicits can be used declare a value to be provided as a default as
    ...
    //Matchers based off types, uncomment the second line here and see what happens
//    implicit var derpRate = BigDecimal(10.00)
    ...
    howMuchCanIMake_?(95)(10) should be(950)
  }
  ...
  koan("""Implicit Function Parameters can contain a list of implicits""") {
    ...
    howMuchCanIMake_?(95)(BigDecimal(95.0), "Dollars") should be ("9025.0 Dollars")
  }
